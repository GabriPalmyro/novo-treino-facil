...
class SelectSetModal extends StatelessWidget {
  ...
  SelectSetModal({required this.idPlanilha, required this.titlePlanilha, required this.tamPlan, required this.idUser, this.isPersonalAcess = false, required this.refetchExercicies});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                InkWell(
                  onTap: () async {
                    await context.read<ExercisesManager>().loadMyListExercises(idUser: context.read<UserManager>().user.id!);
                    ...
                    showModalBottomSheet(
                      ...
                      builder: (_) => ListaExerciciosModal(
                        ...
                        refetchExercicies: refetchExercicies,
                      ),
                    );
                  },
                  child: Container(
