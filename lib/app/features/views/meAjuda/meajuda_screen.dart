...
class _MeAjudaScreenState extends State<MeAjudaScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<MeAjudaController>(builder: (_, meAjuda, __) {
      return Scaffold(
        appBar: AppBar(
          elevation: 0,
                                  ...
                                  onTap: () {
                                    showModalBottomSheet(
                                        ...
                                        builder: (_) => AjudaDetailsScreen(
                                              title: meAjuda
                                                  .listaAjudas[index].title,
                                              description: meAjuda
                                                  .listaAjudas[index]
                                                  .description,
                                              link: meAjuda
                                                  .listaAjudas[index].link,
                                            ));
                                  },
                                  child: Container(
                                    child: Column(
